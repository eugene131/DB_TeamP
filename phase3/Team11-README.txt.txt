## 실행 및 사용방법
- public class MedicineJDBC 바로 밑줄에 있는 URL, USER_UNIVERSITY, USER_PASSWD를 사용환경에 맞게 바꿔주어야 합니다.
(MedicineJDBC.java 프로그램은 phase2에서 작성된 DDL로 해당 계정의 table 생성, 튜플이 insert 되었다고 가정하고 구현되었습니다)
(phase2에서 작성된 DDL(table, query 등)의 수정된 파일은 함께 첨부하였습니다.)

- 프로그램 실행 시 고객로그인 메뉴와 약사 로그인 메뉴가 있는데 각 메뉴에 맞게 ID를 입력해야 아래 기능을 사용할 수 있습니다.
ex) 고객 로그인 id : 111223344
     약사 로그인 id : 1
