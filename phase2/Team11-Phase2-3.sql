...
-- 처방전을 갖고있는 사람의 주문날짜, ID, 이름
SELECT O.Order_date, O.Client_ID, C.Name
FROM M_ORDER O, CLIENT C
WHERE O.Client_ID = C.ID AND O.Prescription = 1;
/*
ORDER_DA CLIENT_ID  NAME
-------- ---------- ----------
18/05/25 111224444  박영수
18/06/15 111229999  김문규
18/05/15 111335555  전종훈
18/03/13 111336666  최자혁
18/04/05 111338888  박서준
18/06/10 111339990  이경수
18/02/08 111445555  임비산
18/06/18 111557777  윤정원
18/06/18 111557777  윤정원
18/06/18 111558888  김석환
18/06/17 111667777  최하선

ORDER_DA CLIENT_ID  NAME
-------- ---------- ----------
18/01/25 111669999  육병주
18/06/19 111669999  육병주
18/06/19 111669999  육병주
18/02/10 111779999  홍성찬
18/06/18 111779999  홍성찬
18/06/19 222334444  최라정
18/01/15 222336666  마영란
18/03/05 222336666  마영란
18/06/18 222338888  최강혜
18/06/19 222339999  김서정
18/06/18 222445555  한선옥

ORDER_DA CLIENT_ID  NAME
-------- ---------- ----------
18/06/15 222445555  한선옥
18/06/14 222445555  한선옥
18/04/26 222446666  마순하
18/03/01 222449999  길기연
18/06/15 222449999  길기연
18/06/18 222556666  송태연
18/06/18 222557777  조혜린
18/06/15 222559999  윤근혜
18/06/19 222778888  최라정
18/06/15 222778888  최라정
18/06/19 222779999  한가온

ORDER_DA CLIENT_ID  NAME
-------- ---------- ----------
18/06/15 222779999  한가온
18/02/15 222889999  마세연
18/06/15 222334466  이예주
18/06/19 222334488  손소혜
18/06/18 222334488  손소혜

38 행이 선택되었습니다.
*/

-- 4) Type 2: Multi-way join with join predicates in WHERE
-- 약사의 이름과 그 약사가 일하고 있는 약국이름 조회
SELECT C.Name, P.Name
FROM CHEMIST C, PHARMACY P
WHERE P.Pharmacy_num = C.Pharmacy_num;
/*
NAME       NAME
---------- ------------------------------
이민준     365정화약국
...
FROM CLIENT C, CONTAIN CO, M_ORDER O
WHERE C.ID = O.Client_ID AND CO.Client_ID = O.Client_ID 
AND O.Order_num = CO.Order_num
...
-- 고객 별 가진 증상의 수와 증상 수가 많은 순서대로 ID, 이름 조회
SELECT C.ID, C.Name, COUNT(*) as Symptom_CNT
FROM CLIENT C, HAVE H
